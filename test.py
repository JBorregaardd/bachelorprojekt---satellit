...
CLIENT_ID = "8ac20a96-b3c3-429b-bb3f-e08ea33ef57c"
CLIENT_SECRET = "oD53CmGkGZXyu1CsvibhrEiFX9eAC4RV"
...
for i in range(0,1):
    ...
    def get_NDWI_request(time_interval):
        return SentinelHubRequest(
            ...
            data_folder="C:/Users/Jacob/.vscode/repositories/b-projekt/bachelorprojekt---satellit/sat_download", # change to where you want your data output
            input_data=[
    ...
    if __name__ == "__main__":
        root_folder = "C:/Users/Jacob/.vscode/repositories/b-projekt/bachelorprojekt---satellit/sat_download"
    ...
    if __name__ == "__main__":
            root_folder = "C:/Users/Jacob/.vscode/repositories/b-projekt/bachelorprojekt---satellit/sat_download" # set to your root folder
    ...
    download_root_directory = "C:/Users/Jacob/.vscode/repositories/b-projekt/bachelorprojekt---satellit/sat_download" # set to your root folder
    ...
    closest_date_index = np.argmin(time_diffs)# Get the closest date from the array
